...
<body>	
	...
	<%
		...
		ResultSet rs;
		int i=st.executeUpdate("update acesso values(null,'"+user+"','"+pwd+"')");
		    i=st.executeUpdate("update pacientes values (null,'"+name+"','"+lastName+"','"+Email+"','"+RG+"','"+CPF+"','"+CEP+"','"+number+"','"+complement+"')");
